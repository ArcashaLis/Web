...
console.log('Задание 4.1. Напишите сценарий, который возвращает наименьший из переданных аргументов.')
function findMin() {
...
let result = findMin(5, 4, 3, 2, 1);
console.log('Наименьший аргумент из значений (5, 4, 3, 2, 1):', result);


console.log('Задание 4.2. Напишите сценарий, который для строки выполняет поиск и возвращает позицию первого символа первого вхождения указанной подстроки в строке.')

function findSubstringPosition(mainString, substring) {
    let position = mainString.indexOf(substring);
    return position;
}
let mainString = 'Это пример строки для поиска.';
console.log('строка: ', mainString)
let substringToFind = 'пример';
console.log('подстрока: ', substringToFind)

let position = findSubstringPosition(mainString, substringToFind);

if (position !== -1) {
    console.log('Первое вхождение подстроки "' + substringToFind + '" начинается с позиции:', position);
} else {
...
let inputString = "pple";
let userSymbol = "a";
console.log('pple начинается с a', startsWithSymbol(inputString, userSymbol)); 
